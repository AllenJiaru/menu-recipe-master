...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings/email', name: 'EmailConfig', component: () => import('@/views/settings/EmailConfigView.vue'), meta: { title: '邮件设置', icon: 'Message' } },
      ...
      { path: 'ai/semantic-search', name: 'AiSemanticSearch', component: () => import('@/views/ai/AiSemanticSearchView.vue'), meta: { title: 'AI 语义搜索', icon: 'Search' } },
      { path: 'ai/smart-order', name: 'AiSmartOrder', component: () => import('@/views/ai/AiSmartOrderView.vue'), meta: { title: 'AI 智能点餐', icon: 'Dish' } },
      { path: 'ai/recipe-assist', name: 'AiRecipeAssist', component: () => import('@/views/ai/AiRecipeAssistView.vue'), meta: { title: 'AI 菜谱创作', icon: 'Edit' } },
      { path: 'ai/inventory-advisor', name: 'AiInventoryAdvisor', component: () => import('@/views/ai/AiInventoryAdvisorView.vue'), meta: { title: 'AI 库存顾问', icon: 'Box' } },
      { path: 'ai/inventory-predict', name: 'AiInventoryPredict', component: () => import('@/views/ai/AiInventoryPredictView.vue'), meta: { title: 'AI 库存预测', icon: 'TrendCharts' } },
      { path: 'ai/scene-menu', name: 'AiSceneMenu', component: () => import('@/views/ai/AiSceneMenuView.vue'), meta: { title: 'AI 场景菜单', icon: 'Calendar' } },
      { path: 'ai/data-insight', name: 'AiDataInsight', component: () => import('@/views/ai/AiDataInsightView.vue'), meta: { title: 'AI 数据洞察', icon: 'DataAnalysis' } },
      { path: 'ai/copywriting', name: 'AiCopywriting', component: () => import('@/views/ai/AiCopywritingView.vue'), meta: { title: 'AI 文案助手', icon: 'EditPen' } },
      { path: 'ai/smart-schedule', name: 'AiSmartSchedule', component: () => import('@/views/ai/AiSmartScheduleView.vue'), meta: { title: 'AI 智能排班', icon: 'UserFilled' } },
      { path: 'ai/user-profile', name: 'AiUserProfile', component: () => import('@/views/ai/AiUserProfileView.vue'), meta: { title: 'AI 用户画像', icon: 'User' } },
      { path: 'ai/trend-predict', name: 'AiTrendPredict', component: () => import('@/views/ai/AiTrendPredictView.vue'), meta: { title: 'AI 趋势预测', icon: 'Sunny' } },
      { path: 'ai/menu-analysis', name: 'AiMenuAnalysis', component: () => import('@/views/ai/AiMenuAnalysisView.vue'), meta: { title: 'AI 整桌菜分析', icon: 'Grid' } },
      { path: 'ai/order-analysis', name: 'AiOrderAnalysis', component: () => import('@/views/ai/AiOrderAnalysisView.vue'), meta: { title: 'AI 订单分析', icon: 'ShoppingCart' } },
      { path: 'ai/history', name: 'AiHistory', component: () => import('@/views/ai/AiHistoryView.vue'), meta: { title: 'AI 使用历史', icon: 'Clock' } }
    ]
  },
